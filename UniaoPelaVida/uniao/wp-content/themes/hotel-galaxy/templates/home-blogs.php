...
?>
<section class="home-blogs-section animate" data-anim-type="zoomIn" data-anim-delay="800" style="background:url('<?php echo $hotel_galaxy_settings['blog_section_bg']; ?>') no-repeat fixed 0 0 / cover  #000000;">
					...
					<div class="section-title animate fadeInLeft" style="margin:30px 0px;">
						<h1 class="heading head-m feature-title" style="color:#fff;">
							...
							if($hotel_galaxy_settings['blog_title']){
								echo esc_attr($hotel_galaxy_settings['blog_title']);
							}else{
